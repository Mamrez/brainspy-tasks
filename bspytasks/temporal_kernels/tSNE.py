...
if __name__ == '__main__':
    ...
    dnpu_preprocessed_data_dir    = "C:/Users/Mohamadreza/Documents/github/brainspy-tasks/tmp/projected_spoken_mnist/theo/train/dnpu_output_train.npy"
    dnpu_preprocessed_label_dir= "C:/Users/Mohamadreza/Documents/github/brainspy-tasks/tmp/projected_spoken_mnist/theo/train/train_labels.npy"

    data_dnpu_preprocessed = np.load(
    ...
    x_dnpu = np.zeros((len(data_dnpu_preprocessed), 496))
    ...
    tsne = TSNE(random_state = 42, n_components=2,verbose=0, perplexity=40, n_iter=300).fit_transform(x_dnpu)
