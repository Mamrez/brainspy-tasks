...
def measurement(
    ...
    dataset_np = np.load("C:/Users/Mohamadreza/Documents/github/brainspy-tasks/bspytasks/temporal_kernels/GoogleSpeechCommands/dataset/SUBSET/numpy_audios/dataset_np.npy", allow_pickle=True)
    labels_np = np.load("C:/Users/Mohamadreza/Documents/github/brainspy-tasks/bspytasks/temporal_kernels/GoogleSpeechCommands/dataset/SUBSET/numpy_audios/labels_np.npy", allow_pickle=True)
...
if __name__ == '__main__':
    ...
    configs = load_configs(
        "C:/Users/Mohamadreza/Documents/github/brainspy-tasks/configs/defaults/processors/hw_gsc.yaml"
    )
    measurement(
        configs,
        64,
