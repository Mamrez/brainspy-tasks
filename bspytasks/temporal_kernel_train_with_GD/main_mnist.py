...
DRIVER = get_driver(
    load_configs(
        "configs/defaults/processors/hw_mnist.yaml"
    )["driver"]
)
...
if __name__ == "__main__":
    ...
    train_dataset = torchvision.datasets.MNIST(root = './tmp/mnist',
                                            train = True,
    ...
    test_dataset = torchvision.datasets.MNIST(root = './tmp/mnist',
                                            train = False,
                                            transform = transforms.Compose([
                                                    transforms.Resize((28,28)),
                                                    transforms.ToTensor(),
